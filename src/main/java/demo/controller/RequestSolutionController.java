...
public class RequestSolutionController {
    ...
    public JSONObject requestSolution(String algorithmFileInputPath, String algorithmFileId,int flag) {
...
//        orToolsJobApp.defineObjective();
        List<PhaseOneAssignedTask> phaseOneAssignedTasks = orToolsJobApp.solvePhaseNew();
