...
@AllArgsConstructor
@NoArgsConstructor
public class PhaseOneLastAssignedTask extends AssignedTask implements Serializable{
    ...
    public PhaseOneLastAssignedTask(String originalId, Integer start, Integer hoursDuration){
