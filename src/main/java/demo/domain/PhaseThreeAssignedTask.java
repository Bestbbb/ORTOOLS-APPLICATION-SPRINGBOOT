...
@AllArgsConstructor
@NoArgsConstructor
public class PhaseThreeAssignedTask extends AssignedTask implements Serializable {
    ...
    public PhaseThreeAssignedTask(String originalId, Integer start, Integer hoursDuration){
